...
#define get_MIPIDSI_PHY_STATUS()\
	(inp32(get_dsi_virtual_addr() + MIPIDSI_PHY_STATUS_ADDR))
#define get_MIPIDSI_CMD_PKT_STATUS() \
	(inp32(get_dsi_virtual_addr() + MIPIDSI_CMD_PKT_STATUS_ADDR))
#define get_MIPIDSI_GEN_PLD_DATA() \
	(inp32(get_dsi_virtual_addr() + MIPIDSI_GEN_PLD_DATA_ADDR))
#define set_NO_CONTINUE_MOD_CTRL(nVal)\
	{outp32(get_dsi_virtual_addr() + MIPIDSI_NO_CONTINUE_ADDR, nVal); }

/* Version of the DSI host controller */
union MIPIDSI_VERSION_UNION {
	struct {
		u32 version : 32;
	} bits;
	u32 ul32;
...
union MIPIDSI_CLKMGR_CFG_UNION {
       struct {
...
union MIPIDSI_PHY_CLK_DATA_TMG_CFG_UNION {
       struct {
...
union MIPIDSI_DPI_COLOR_CODING_UNION {
	struct {
...
union MIPIDSI_DPI_CFG_POL_UNION {
	struct {
...
union MIPIDSI_PCKHDL_CFG_UNION {
       struct {
               u32 eotp_tx_en  : 1;
               u32 eotp_rx_en  : 1;
               u32 bta_en      : 1;
...
union MIPIDSI_DPI_LP_CMD_TIM_UNION {
	struct {
...
union MIPIDSI_DBI_PARTITIONING_EN_UNION {
	struct {
...
union MIPIDSI_DBI_CMDSIZE_UNION {
	struct {
		u32 wr_cmd_size         : 16;
...
union MIPIDSI_VID_MODE_CFG_UNION {
	struct {
		u32 vid_mode_type    : 2;
		u32 reserved0        : 6;
		u32 lp_vsa_en        : 1;
...
union MIPIDSI_VID_PKT_SIZE_UNION {
	struct {
		u32 vid_pkt_size    : 14;
		u32 reserved0       : 18;
	} bits;
...
union MIPIDSI_VID_NUM_CHUNKS_UNION {
	struct {
...
union MIPIDSI_VID_NULL_SIZE_UNION {
	struct {
...
union MIPIDSI_VID_HSA_TIME_UNION {
	struct {
		u32 vid_hsa_time    : 12;
		u32 reserved0       : 20;
	} bits;
...
union MIPIDSI_VID_HBP_TIME_UNION {
	struct {
		u32 vid_hbp_time    : 12;
		u32 reserved0       : 20;
	} bits;
...
union MIPIDSI_VID_HLINE_TIME_UNION {
	struct {
...
union MIPIDSI_VID_VSA_LINES_UNION {
	struct {
		u32 vsa_lines   : 10;
		u32 reserved0   : 22;
	} bits;
...
union MIPIDSI_VID_VBP_LINES_UNION {
	 struct {
		u32 vbp_lines   : 10;
		u32 reserved0   : 22;
	} bits;
...
union MIPIDSI_VID_VFP_LINES_UNION {
	struct {
		u32 vfp_lines   : 10;
		u32 reserved0   : 22;
	} bits;
...
union MIPIDSI_VID_VACTIVE_LINES_UNION {
	struct {
...
union MIPIDSI_EDPI_CMD_SIZE_UNION {
	struct {
...
union MIPIDSI_CMD_MODE_CFG_UNION {
	struct {
...
union MIPIDSI_GEN_PLD_DATA_UNION {
	struct {
		u32 gen_pld_b1  : 8;
		u32 gen_pld_b2  : 8;
		u32 gen_pld_b3  : 8;
...
union MIPIDSI_CMD_PKT_STATUS_UNION {
	struct {
...
union MIPIDSI_TO_CNT_CFG_UNION {
	struct {
		u32 lprx_to_cnt : 16;
		u32 hstx_to_cnt : 16;
	} bits;
...
union MIPIDSI_HS_RD_TO_CNT_UNION {
	struct {
		u32 hs_rd_to_cnt    : 16;
		u32 reserved0       : 16;
	} bits;
...
union MIPIDSI_LP_RD_TO_CNT_UNION {
	struct {
		u32 lp_rd_to_cnt    : 16;
		u32 reserved0       : 16;
	} bits;
...
union MIPIDSI_HS_WR_TO_CNT_UNION {
	struct {
		u32 hs_wr_to_cnt    : 16;
		u32 reserved0       : 8;
		u32 presp_to_mode   : 1;
...
union MIPIDSI_LP_WR_TO_CNT_UNION {
	struct {
		u32 lp_wr_to_cnt    : 16;
		u32 reserved0       : 16;
	} bits;
...
union MIPIDSI_BTA_TO_CNT_UNION {
	struct {
		u32 bta_to_cnt  : 16;
		u32 reserved0   : 16;
	} bits;
...
union MIPIDSI_LPCLK_CTRL_UNION {
	struct {
...
union MIPIDSI_PHY_TMR_LPCLK_CFG_UNION {
	struct {
...
union MIPIDSI_PHY_TMR_CFG_UNION {
	struct {
		u32 max_rd_time     : 15;
		u32 reserved0       : 1;
...
union MIPIDSI_PHY_IF_CFG_UNION {
	struct {
		u32 n_lanes             : 2;
		u32 reserved0           : 6;
...
union MIPIDSI_PHY_ULPS_CTRL_UNION {
	struct {
...
union MIPIDSI_PHY_TX_TRIGGERS_UNION {
	struct {
...
union MIPIDSI_PHY_STATUS_UNION {
	struct {
...
union MIPIDSI_PHY_TST_CTRL0_UNION {
	struct {
		u32 phy_testclr : 1;
		u32 phy_testclk : 1;
		u32 reserved0   : 30;
...
union MIPIDSI_PHY_TST_CTRL1_UNION {
	struct {
		u32 phy_testdin     : 8;
		u32 phy_testdout    : 8;
		u32 phy_testen      : 1;
